...
<div x-data="{ show: true }" x-show="show" {{ $attributes->merge(['class' => "{$types[$type]} p-4 rounded-lg"]) }} role="alert">
        ...
        @if($dismissible)
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <button type="button" @click="show = false" class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 {{ $types[$type] }}">
